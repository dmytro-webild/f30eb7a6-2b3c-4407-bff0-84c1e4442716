...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        {
          imageSrc: "http://img.b2bpic.net/free-photo/business-people-working-laptops-meeting_53876-20850.jpg",
  ...
  <div id="about" data-section="about">
      ...
      description={[
        "Vantage is a premium agency built for the top 1% of brands. We don't just post content; we engineer growth.",
        "Our methodology combines psychological data, viral engineering, and ultra-high-end visual production.",
      ]}
    />
  </div>
      ...
      metrics={[
        {
          id: "m1",
          value: "150M+",
          description: "Combined Monthly Reach",
        },
        {
          id: "m2",
          value: "340%",
        ...
        },
        {
          id: "m3",
          value: "25+",
          description: "Global Brands Scaled",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Algorithmic strategies customized for your brand.",
          phoneOne: {
        ...
        },
        {
          ...
          description: "Cinematic visual assets for every platform.",
          phoneOne: {
        ...
        {
          title: "Viral Brand Voice",
          description: "Crafting a narrative that resonates globally.",
          phoneOne: {
      ...
      testimonials={[
        {
          id: "1",
          title: "Exceptional",
          quote: "Vantage completely transformed our social presence.",
          name: "Alex Rivet",
          role: "CEO, Rivet Tech",
        ...
        },
        {
          ...
          quote: "The results have been nothing short of staggering.",
          name: "Maria Chen",
          role: "CMO, Nova Labs",
        ...
        },
        {
          id: "3",
          title: "World Class",
          quote: "They possess an incredible eye for detail and growth.",
          name: "James O'Neal",
          role: "Founder, O'Neal Group",
          imageSrc: "http://img.b2bpic.net/free-photo/positive-confident-businesswoman-wearing-formal-suit-standing-with-arms-folded_74855-10328.jpg",
        },
        {
          id: "4",
          title: "Phenomenal",
          quote: "Vantage is simply the best in the business.",
          name: "Sarah Miller",
          role: "VP Marketing, Apex",
          imageSrc: "http://img.b2bpic.net/free-photo/portrait-beautiful-woman-posing-with-yellow-jacket_23-2149020793.jpg",
        },
        {
          id: "5",
          title: "Stellar",
          quote: "The strategic depth they provide is unmatched.",
          name: "David Park",
      ...
      faqs={[
        {
          ...
          content: "Book a discovery call so we can understand your objectives.",
        },
        {
          id: "f2",
          title: "What is the ROI timeframe?",
          content: "Growth typically begins to show significant traction in 60 days.",
        },
        {
          id: "f3",
          title: "Do you work with startups?",
          content: "We work with brands that have an established market fit.",
        },
      ]}
